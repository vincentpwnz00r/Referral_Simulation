...
//		seven.addChild(12);
//		seven.addChild(13);
//		IncentiveNode<Integer> thirteen = seven.children.get(1);
//		thirteen.addChild(14);
//		IncentiveNode<Integer> fourteen = thirteen.children.get(0);
//		fourteen.addChild(15);
		...
		Boolean  pB,iB,tB;
		double priceThreshold = 0.7;
		double incentiveThreshold = 0.8;
		double typeThreshold = 0.87;
		...
		for(int z = 0; z < 100; z++) {
			...
			afterSimDepth += n.deepestDepth(rootSim, 0);
			afterSimNodes += ds.childDesc(rootSim);
			afterSimSSAuthorProfit += s.authorProfit(rootSim,1,1);
			afterSimDSAuthorProfit += ds.authorProfit(rootSim,1,1);
			afterSimRecAuthorProfit += rec.authorProfit(rootSim,1,1);
			afterSimShapAuhtorProfit += shap.authorProfit(rootSim,1);
...
//			if(numNodesInFirst == 0) {
//				numNodesInFirst = 1.0;
//			}
//			if(numNodesInSecond == 0) {
//				numNodesInFirst = 1.0;
//			}
//			if(numNodesInThird == 0) {
//				numNodesInFirst = 1.0;
//			}
//			if(numNodesInFourth == 0) {
//				numNodesInFirst = 1.0;
//			}if(numNodesInFifth == 0) {
//				numNodesInFirst = 1.0;
//			}

			//System.out.println("number of nodes in third: " +numNodesInThird);

			afterSimSSFirst += numNodesSS(rootSim,1,s);
			afterSimSSSecond +=numNodesSS(rootSim,2,s);
			afterSimSSThird += numNodesSS(rootSim,3,s);
			//System.out.println("revenue in third Node:" +afterSimSSThird);
			afterSimSSFourth +=  numNodesSS(rootSim,4,s);
			afterSimSSFifth +=  numNodesSS(rootSim,5,s);

			afterSimDSFirst += numNodesDS(rootSim,1,ds);
			afterSimDSSecond += numNodesDS(rootSim,2,ds);
			afterSimDSThird += numNodesDS(rootSim,3,ds);
			afterSimDSFourth += numNodesDS(rootSim,4,ds);
			afterSimDSFifth += numNodesDS(rootSim,5,ds);
...
//			System.out.println(p.yesOrNo(t, 0.5));
//		}

		//System.out.println("Counter number is :" + counter);
		//System.out.println(s.childSize(root));
		//System.out.println(n.checkDepth(root));
